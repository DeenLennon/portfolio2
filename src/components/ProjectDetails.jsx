...
const PORTFOLIO_ITEMS = [
  ...
  },
  {
    ...
    longDescription: "Built from the ground up to address the unique needs of student communities. The platform enables real-time collaboration on group projects, shared resource libraries with version control, and an AI-powered study buddy matching system. in progress...",
  ...
  },
  {
    ...
    longDescription: "A high-performance news aggregation platform that delivers personalized content through machine learning algorithms. Handles thousands of concurrent users with sub-second update latency using GraphQL subscriptions and edge caching. in progress...",
    tags: ["Next.js", "GraphQL", "PostgreSQL"],
    link: "/projects/news-blog",
    liveUrl: "https://example.com/news-blog",
    githubUrl: "https://github.com/deenlennon/news-blog",
    features: [
    ...
    techStack: ["Node.js", "React", "GraphQL", "PostgreSQL", "Redis", "Elasticsearch", "Vercel"],
    year: "2026",
  ...
  },
  {
    ...
    description: "Complete guide to creating stunning web animations using modern CSS, SCSS and Framer Motion techniques.",
    longDescription: "An educational platform focused entirely on web animation. Includes interactive playgrounds where users can post codes for review. Covers CSS animations. in progress...",
    tags: ["CSS3", "Sass", "Framer Motion"],
    link: "/projects/animation-course",
    liveUrl: "https://example.com/animation-course",
    githubUrl: "https://github.com/deenlennon/animation-course",
    features: [
      "Post for Code Review",
      "Step-by-step tutorial system",
      "Performance benchmarking tools",
    ],
    techStack: ["React", "Github", "Three.js", "Framer Motion", "Sass", "Vite"],
    year: "2026",
  ...
  },
  {
    ...
    longDescription: "A complete e-commerce solution for an electrical supply company. Features include real-time inventory tracking, automated reordering, multi-currency support, and integration with major payment gateways including Stripe and PayPal. in progress...",
    ...
    techStack: ["React", "Node.js", "GitHub", "MySQL", "Express"],
    year: "2026",
    role: "Full Stack Developer",
  },
];
